...
@section('title', 'Admin Registration | Harlan Group')
...
<div class="login-container">
    <div class="login-card">
        ...
        <p class="login-subtitle">Register a new admin account</p>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="input-group">
                ...
                <input type="text" name="name" class="login-input" value="{{ old('name') }}" placeholder="John Doe" required autofocus>
            </div>

            <div class="input-group">
                <label class="input-label">Email Address</label>
                <input type="email" name="email" class="login-input" value="{{ old('email') }}" placeholder="admin@harlangroup.com" required>
            </div>
        ...
        <div style="margin-top: 30px; display: flex; justify-content: space-between;">
            ...
            <a href="{{ route('login') }}" style="color: var(--primary); font-size: 14px; text-decoration: none; font-weight: 600;">Already have an account?</a>
        </div>
    </div>
</div>
@endsection
